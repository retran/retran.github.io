...
/** @type {string} */
const CACHE_VERSION = '1771782781|1385330';
/** @type {string} */
const CACHE_PREFIX = 'planetgen-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'planetgen.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["planetgen.html","planetgen.js","planetgen.offline.html","planetgen.icon.png","planetgen.apple-touch-icon.png","planetgen.audio.worklet.js","planetgen.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["planetgen.wasm","planetgen.pck"];
